                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <div className="flex items-center bg-gray-900">
                            <h1 className="h-8 mr-3 text-white font-semibold whitespace-nowra text-2xl">Ativos<span color="orange" className="text-primary self-center text-2xl font-semibold whitespace-nowrap dark:text-primary"> PB</span> </h1>
                        </div>
                    </div>
